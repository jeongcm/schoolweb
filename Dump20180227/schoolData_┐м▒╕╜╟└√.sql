...
--
-- Table structure for table `연구실적`
--

DROP TABLE IF EXISTS `연구실적`;
...
--
-- Dumping data for table `연구실적`
--

LOCK TABLES `연구실적` WRITE;
/*!40000 ALTER TABLE `연구실적` DISABLE KEYS */;
/*!40000 ALTER TABLE `연구실적` ENABLE KEYS */;
UNLOCK TABLES;
