...
--
-- Table structure for table `연구실적양식`
--

DROP TABLE IF EXISTS `연구실적양식`;
...
--
-- Dumping data for table `연구실적양식`
--

LOCK TABLES `연구실적양식` WRITE;
/*!40000 ALTER TABLE `연구실적양식` DISABLE KEYS */;
/*!40000 ALTER TABLE `연구실적양식` ENABLE KEYS */;
UNLOCK TABLES;
