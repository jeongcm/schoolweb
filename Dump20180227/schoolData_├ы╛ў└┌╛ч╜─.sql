...
--
-- Table structure for table `취업자양식`
--

DROP TABLE IF EXISTS `취업자양식`;
...
--
-- Dumping data for table `취업자양식`
--

LOCK TABLES `취업자양식` WRITE;
/*!40000 ALTER TABLE `취업자양식` DISABLE KEYS */;
/*!40000 ALTER TABLE `취업자양식` ENABLE KEYS */;
UNLOCK TABLES;
