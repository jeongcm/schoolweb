...
--
-- Table structure for table `취업제외자`
--

DROP TABLE IF EXISTS `취업제외자`;
...
--
-- Dumping data for table `취업제외자`
--

LOCK TABLES `취업제외자` WRITE;
/*!40000 ALTER TABLE `취업제외자` DISABLE KEYS */;
/*!40000 ALTER TABLE `취업제외자` ENABLE KEYS */;
UNLOCK TABLES;
