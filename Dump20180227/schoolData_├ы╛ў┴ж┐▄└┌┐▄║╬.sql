...
--
-- Table structure for table `취업제외자외부`
--

DROP TABLE IF EXISTS `취업제외자외부`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `취업제외자외부` (
...
--
-- Dumping data for table `취업제외자외부`
--

LOCK TABLES `취업제외자외부` WRITE;
/*!40000 ALTER TABLE `취업제외자외부` DISABLE KEYS */;
/*!40000 ALTER TABLE `취업제외자외부` ENABLE KEYS */;
UNLOCK TABLES;
