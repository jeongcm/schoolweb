...
--
-- Table structure for table `봉사실적`
--

DROP TABLE IF EXISTS `봉사실적`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `봉사실적` (
  `연번` int(11) NOT NULL AUTO_INCREMENT,
  `년도` int(11) NOT NULL,
  `학기` char(5) DEFAULT NULL,
...
--
-- Dumping data for table `봉사실적`
--

LOCK TABLES `봉사실적` WRITE;
/*!40000 ALTER TABLE `봉사실적` DISABLE KEYS */;
/*!40000 ALTER TABLE `봉사실적` ENABLE KEYS */;
UNLOCK TABLES;
