...
--
-- Table structure for table `수상실적양식`
--

DROP TABLE IF EXISTS `수상실적양식`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `수상실적양식` (
  `년도` int(11) NOT NULL DEFAULT '2015',
  `학과명` varchar(15) NOT NULL,
  `대회규모구분` varchar(10) NOT NULL,
...
--
-- Dumping data for table `수상실적양식`
--

LOCK TABLES `수상실적양식` WRITE;
/*!40000 ALTER TABLE `수상실적양식` DISABLE KEYS */;
/*!40000 ALTER TABLE `수상실적양식` ENABLE KEYS */;
UNLOCK TABLES;
