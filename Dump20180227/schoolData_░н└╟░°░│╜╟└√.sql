...
--
-- Table structure for table `강의공개실적`
--

DROP TABLE IF EXISTS `강의공개실적`;
...
--
-- Dumping data for table `강의공개실적`
--

LOCK TABLES `강의공개실적` WRITE;
/*!40000 ALTER TABLE `강의공개실적` DISABLE KEYS */;
/*!40000 ALTER TABLE `강의공개실적` ENABLE KEYS */;
UNLOCK TABLES;
