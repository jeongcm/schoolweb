...
--
-- Table structure for table `연구실적외부`
--

DROP TABLE IF EXISTS `연구실적외부`;
...
--
-- Dumping data for table `연구실적외부`
--

LOCK TABLES `연구실적외부` WRITE;
/*!40000 ALTER TABLE `연구실적외부` DISABLE KEYS */;
/*!40000 ALTER TABLE `연구실적외부` ENABLE KEYS */;
UNLOCK TABLES;
