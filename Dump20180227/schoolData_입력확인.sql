...
INSERT INTO `입력확인` VALUES ('admin','입력중'),('간호학과','입력중'),('건축공학전공','입력중'),('건축학전공','입력중'),('경영정보학과','입력중'),('경영학전공','입력중'),('교무과','입력중'),('교수학습개발원','입력중'),('국제교류본부','입력중'),('국제통상학과','입력중'),('기계공학전공','입력중'),('기타','입력중'),('기획과','입력중'),('나노고분자공학전공','입력중'),('대학원','입력중'),('도시교통공학전공','입력중'),('디자인학부','입력중'),('물리치료학과','입력중'),('비즈니스영어전공','입력중'),('사회복지학전공','입력중'),('산업경영공학전공','입력중'),('산업디자인전공','입력중'),('산학협력단','입력중'),('생명공학전공','입력중'),('소프트웨어학전공','입력중'),('스포츠건강관리학전공','입력중'),('스포츠산업학전공','입력중'),('식품공학전공','입력중'),('식품영양학전공','입력중'),('신소재공학전공','입력중'),('안전공학전공','입력중'),('자동차공학전공','입력중'),('영어영문학전공','입력중'),('유아교육학과','입력중'),('유아특수교육학과','입력중'),('음악학과','입력중'),('응급구조학과','입력중'),('의료IT공학전공','입력중'),('입학관리과','입력중'),('전기공학전공','입력중'),('전자공학전공','입력중'),('정보기술융합학부','입력중'),('정보통신로봇공학전공','입력중'),('중국어전공','입력중'),('창업보육센터','입력중'),('철도경영물류학전공','입력중'),('철도인프라시스템공학전공','입력중'),('철도운전시스템전공','입력중'),('철도전기전자전공','입력중'),('철도차량시스템전공','입력중'),('취업창업지원과','입력중'),('커뮤니케이션디자인전공','입력중'),('컴퓨터공학전공','입력중'),('컴퓨터정보공학전공','입력중'),('토목공학전공','입력중'),('학사관리과','입력중'),('학생과','입력중'),('한국어문학전공','입력중'),('항공기계설계전공','입력중'),('항공서비스학과','입력중'),('항공운항학과','입력중'),('행정정보학전공','입력중'),('행정학전공','입력중'),('화공생물공학전공','입력중'),('환경공학전공','입력중'),('기계자동차항공공학부','입력중'),('전기전자로봇통신공학부','입력중'),('건설환경도시교통공학부','입력중'),('화공신소재고분자공학부','입력중'),('산업경영안전공학부','입력중'),('건축학부','입력중'),('디자인학부','입력중'),('컴퓨터정보기술공학부','입력중'),('글로벌어문학부','입력중'),('행정학부','입력중'),('경영통상복지학부','입력중'),('스포츠학부','입력중'),('식품생명학부','입력중'),('철도공학부','입력중');
