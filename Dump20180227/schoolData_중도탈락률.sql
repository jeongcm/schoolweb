...
--
-- Table structure for table `중도탈락률`
--

DROP TABLE IF EXISTS `중도탈락률`;
...
--
-- Dumping data for table `중도탈락률`
--

LOCK TABLES `중도탈락률` WRITE;
/*!40000 ALTER TABLE `중도탈락률` DISABLE KEYS */;
/*!40000 ALTER TABLE `중도탈락률` ENABLE KEYS */;
UNLOCK TABLES;
