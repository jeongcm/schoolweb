...
--
-- Table structure for table `중도탈락률외부양식`
--

DROP TABLE IF EXISTS `중도탈락률외부양식`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `중도탈락률외부양식` (
...
--
-- Dumping data for table `중도탈락률외부양식`
--

LOCK TABLES `중도탈락률외부양식` WRITE;
/*!40000 ALTER TABLE `중도탈락률외부양식` DISABLE KEYS */;
/*!40000 ALTER TABLE `중도탈락률외부양식` ENABLE KEYS */;
UNLOCK TABLES;
