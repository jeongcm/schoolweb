...
<div class="menu">
	...
	%>
		...
		<ul class="depth_1">
			...
			<li><a href="../전임교원1인당연구실적d/전임교원1인당연구실적d.jsp">외부지표_연구실적</a></li>
			<li><a href="../전임교원1인당교외연구비d/전임교원1인당교외연구비d.jsp">외부지표_연구비</a></li>
			<li><a href="../전임교원1인당강의담당비율d/전임교원1인당강의담당비율d.jsp">외부지표_강의담당</a></li>
		</ul>
	...
	%>
		...
		<ul class="depth_1">
			...
			<li><a href="../강의담당상세외부/강의담당상세외부.jsp">외부지표_강의담당상세</a></li>
			<li><a href="../최종결과/A그룹.jsp">A그룹</a></li>
			<li><a href="../최종결과/B그룹.jsp">B그룹</a></li>
			<li><a href="../최종결과/C그룹.jsp">C그룹</a></li>
			<li><a href="../최종결과/D그룹.jsp">D그룹</a></li>
