...
<%
	try {
		...
		ResultSet resultSet = statement.executeQuery("select * from 연구비양식");
		XSSFWorkbook workbook = new XSSFWorkbook();
		XSSFSheet spreadsheet = workbook.createSheet("연구비 양식");
		...
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/") + "연구비양식.xlsx"));
	...
	String filename = "연구비양식.xlsx";

	String orgfilename = "연구비양식.xlsx";
