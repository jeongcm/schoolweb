...
<%
	try {
		...
		ResultSet resultSet = statement.executeQuery("select * from 재학생현황양식 ");
		XSSFWorkbook workbook = new XSSFWorkbook();
		XSSFSheet spreadsheet = workbook.createSheet("재학생 현황 양식");
		...
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/") + "재학생현황양식.xlsx"));
	...
	String filename = "재학생현황양식.xlsx";

	String orgfilename = "재학생현황양식.xlsx";
