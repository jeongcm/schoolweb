...
<%
	try {
		...
		ResultSet resultSet = statement.executeQuery("select * from 전임교원확보율양식 ");
		XSSFWorkbook workbook = new XSSFWorkbook();
		XSSFSheet spreadsheet = workbook.createSheet("전임교원확보율양식");
		...
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/") + "전임교원확보율양식.xlsx"));
	...
	String filename = "전임교원확보율양식.xlsx";

	String orgfilename = "전임교원확보율양식.xlsx";
