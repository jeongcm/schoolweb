...
<%
	try {
		...
		ResultSet resultSet = statement.executeQuery("select * from 취업자양식 ");
		XSSFWorkbook workbook = new XSSFWorkbook();
		XSSFSheet spreadsheet = workbook.createSheet("취업자 양식");
		...
		cell.setCellValue("취업인정자");
		cell = row.createCell(6);
		cell.setCellValue("개인창작활동조사서");
		cell = row.createCell(7);
		cell.setCellValue("1인창업자");
		...
		while (resultSet.next()) {
			...
			cell = row.createCell(5);
			cell.setCellValue(resultSet.getInt("취업인정자"));
			cell = row.createCell(6);
			cell.setCellValue(resultSet.getInt("개인창작활동조사서"));
			cell = row.createCell(7);
			cell.setCellValue(resultSet.getInt("1인창업자"));
			cell = row.createCell(8);
		...
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/") + "취업자양식.xlsx"));
		workbook.write(fo);
		fo.close();
		workbook.close();
	} catch (Exception e) {
	...
	String filename = "취업자양식.xlsx";

	String orgfilename = "취업자양식.xlsx";
