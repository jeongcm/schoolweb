...
<%
	try {
		...
		ResultSet resultSet = statement.executeQuery("select * from 현장실습양식 ");
		XSSFWorkbook workbook = new XSSFWorkbook();
		XSSFSheet spreadsheet = workbook.createSheet("현장실습양식");
		...
		while (resultSet.next()) {
			...
			cell = row.createCell(6);
			cell.setCellValue(resultSet.getInt("대상학생수"));

			i++;
		}
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/") + "현장실습양식.xlsx"));
		workbook.write(fo);
		fo.close();
		workbook.close();
	} catch (Exception e) {
	...
	String filename = "현장실습양식.xlsx";

	String orgfilename = "현장실습양식.xlsx";
