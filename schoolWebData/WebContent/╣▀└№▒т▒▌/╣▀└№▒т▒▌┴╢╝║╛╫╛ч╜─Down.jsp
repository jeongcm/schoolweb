...
<%
	try {
		...
		ResultSet resultSet = statement.executeQuery("select * from 발전기금조성액양식; ");
		XSSFWorkbook workbook = new XSSFWorkbook();
		XSSFSheet spreadsheet = workbook.createSheet("발전기금조성액양식");
		...
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/") + "발전기금조성액양식.xlsx"));
	...
	String filename = "발전기금조성액양식.xlsx";

	String orgfilename = "발전기금조성액양식.xlsx";
