...
<%
	try {
		...
		ResultSet resultSet = statement.executeQuery("select * from 교원현황양식 ");
		XSSFWorkbook workbook = new XSSFWorkbook();
		XSSFSheet spreadsheet = workbook.createSheet("교원현황");
		...
		cell.setCellValue("04.01기준");
		cell = row.createCell(3);
		cell.setCellValue("10.01기준");
		...
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/") + "교원현황양식.xlsx"));
	...
	String filename = "교원현황양식.xlsx";

	String orgfilename = "교원현황양식.xlsx";
