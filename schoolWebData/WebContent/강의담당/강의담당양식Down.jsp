...
<%
	try {
		...
		ResultSet resultSet = statement.executeQuery("select * from 강의담당양식 ");
		XSSFWorkbook workbook = new XSSFWorkbook();
		XSSFSheet spreadsheet = workbook.createSheet("강의담당 양식");
		...
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/") + "강의담당양식.xlsx"));
		workbook.write(fo);
		fo.close();
		workbook.close();
	} catch (Exception e) {
	...
	String filename = "강의담당양식.xlsx";
	String orgfilename = "강의담당양식.xlsx";
	InputStream in = null;
