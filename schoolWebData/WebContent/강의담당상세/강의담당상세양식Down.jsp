...
<%
	try {
		...
		while (resultSet.next()) {
			...
			cell = row.createCell(5);
			cell.setCellValue(resultSet.getFloat("과목"));
			cell = row.createCell(6);
			cell.setCellValue(resultSet.getString("학점"));
			cell = row.createCell(7);
		...
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/") + "강의담당상세양식.xlsx"));
		workbook.write(fo);
		fo.close();
		workbook.close();
	} catch (Exception e) {
	...
	String filename = "강의담당상세양식.xlsx";
	String orgfilename = "강의담당상세양식.xlsx";
