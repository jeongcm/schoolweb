...
<%
	try {
		...
		ResultSet resultSet = statement.executeQuery("select * from 외국인학생현황양식  ");
		XSSFWorkbook workbook = new XSSFWorkbook();
		XSSFSheet spreadsheet = workbook.createSheet("외국인학생현황 양식");
		...
		while (resultSet.next()) {
			...
			cell = row.createCell(5);
			cell.setCellValue(resultSet.getString("국적"));
			cell = row.createCell(6);
			cell.setCellValue(resultSet.getString("성별"));
			cell = row.createCell(7);
		...
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/") + "외국인학생비율양식.xlsx"));
	...
	String filename = "외국인학생비율양식.xlsx";

	String orgfilename = "외국인학생비율양식.xlsx";
