...
<%
	try {
		...
		ResultSet resultSet = statement.executeQuery("select * from 교외장학금양식");
		XSSFWorkbook workbook = new XSSFWorkbook();
		XSSFSheet spreadsheet = workbook.createSheet("교외장학금 양식");
		...
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/") + "교외장학금양식.xlsx"));
...
<%
	...
	String filename = "교외장학금양식.xlsx";

	String orgfilename = "교외장학금양식.xlsx";
