...
<%
	try {
		...
		ResultSet resultSet = statement.executeQuery("select  distinct 학과.단과대학,재학생.*"
				+ " from 재학생현황 재학생 join 학과현황 학과 on 재학생.년도=학과.년도 and 학과.학과명=재학생.학과명 "
				+ "where 기준='10.01'order by 재학생.연번 desc  ");
		XSSFWorkbook workbook = new XSSFWorkbook();
		XSSFSheet spreadsheet = workbook.createSheet("2학기 재학생 현황");
		...
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/") + "2학기재학생현황.xlsx"));
	...
	String filename = "2학기재학생현황.xlsx";

	String orgfilename = "2학기재학생현황.xlsx";
