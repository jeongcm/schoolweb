...
<%
	try {
		...
		ResultSet resultSet = statement.executeQuery("select * from 취업현황양식 ");
		XSSFWorkbook workbook = new XSSFWorkbook();
		XSSFSheet spreadsheet = workbook.createSheet("취업현황외부양식");
		...
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/") + "취업현황외부양식.xlsx"));
		workbook.write(fo);
		fo.close();
		workbook.close();
	} catch (Exception e) {
	...
	String filename = "취업현황외부양식.xlsx";

	String orgfilename = "취업현황외부양식.xlsx";
