...
<%
	try {
		...
		ResultSet resultSet = statement.executeQuery("select * from 취업자외부양식 ");
		XSSFWorkbook workbook = new XSSFWorkbook();
		XSSFSheet spreadsheet = workbook.createSheet("취업자외부 양식");
		...
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/") + "취업자외부양식.xlsx"));
		workbook.write(fo);
		fo.close();
		workbook.close();
	} catch (Exception e) {
	...
	String filename = "취업자외부양식.xlsx";

	String orgfilename = "취업자외부양식.xlsx";
