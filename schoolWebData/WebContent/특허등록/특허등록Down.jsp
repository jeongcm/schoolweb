...
<%
	try {
		...
		ResultSet resultSet = statement.executeQuery("select * from 특허등록view ");
		...
		cell.setCellValue("국내");
		cell = row.createCell(5);
		cell.setCellValue("국제");
		cell = row.createCell(6);
		cell.setCellValue("특허이전료기술이전");
		cell = row.createCell(7);
		cell.setCellValue("특허등록및기술이전수입료");
		...
		while (resultSet.next()) {
			...
			cell = row.createCell(4);
			cell.setCellValue(resultSet.getInt("국내"));
			cell = row.createCell(5);
			cell.setCellValue(resultSet.getInt("국제"));
			cell = row.createCell(6);
			cell.setCellValue(resultSet.getFloat("기술이전"));
			cell = row.createCell(7);
			cell.setCellValue(resultSet.getFloat("수입료"));
			cell = row.createCell(8);
		...
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/") + "특허등록.xlsx"));
...
<%
	...
	String filename = "특허등록.xlsx";

	String orgfilename = "특허등록.xlsx";
