...
<%
	try {
		...
		ResultSet resultSet = statement.executeQuery("select * from 강의담당상세양식 ");
		XSSFWorkbook workbook = new XSSFWorkbook();
		XSSFSheet spreadsheet = workbook.createSheet("강의담당상세 양식");
		...
		while (resultSet.next()) {
			...
			cell = row.createCell(2);
			cell.setCellValue(resultSet.getString("학기"));
			cell = row.createCell(3);
			cell.setCellValue(resultSet.getString("학과명"));
			cell = row.createCell(4);
			cell.setCellValue(resultSet.getString("성명"));
			cell = row.createCell(5);
			cell.setCellValue(resultSet.getString("과목"));
			cell = row.createCell(6);
			cell.setCellValue(resultSet.getFloat("학점"));
			cell = row.createCell(7);
		...
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/") + "강의담당상세외부양식.xlsx"));
		workbook.write(fo);
		fo.close();
		workbook.close();
	} catch (Exception e) {
	...
	String filename = "강의담당상세외부양식.xlsx";
	String orgfilename = "강의담당상세외부양식.xlsx";
