...
<%
	try {
		...
		ResultSet resultSet = statement.executeQuery("select * from 신입생현황양식");
		XSSFWorkbook workbook = new XSSFWorkbook();
		XSSFSheet spreadsheet = workbook.createSheet("신입생현황외부양식");
		...
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/") + "신입생현황외부양식.xlsx"));
	...
	String filename = "신입생현황외부양식.xlsx";

	String orgfilename = "신입생현황외부양식.xlsx";
