...
<%
	try {
		...
		ResultSet resultSet = statement.executeQuery("select * from 연구비외부양식  ");
		XSSFWorkbook workbook = new XSSFWorkbook();
		XSSFSheet spreadsheet = workbook.createSheet("연구비 외부양식 다운");
		...
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/") + "연구비외부양식.xlsx"));
	...
	String filename = "연구비외부양식.xlsx";

	String orgfilename = "연구비외부양식.xlsx";
