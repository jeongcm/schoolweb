	...
	<div class="container">
		...
		<div class="contents">
			<table style="text-align: center;">
				<tr>
					<th colspan="20"><font size="6">[취업률]</font></th>
				</tr>
				<tr>
					<td colspan="20"><input type=button value="엑셀 다운로드" onclick="JavaScript:window.location='취업률Down.jsp'" title="입력되어있는 데이터를 엑셀 형식으로 다운 받습니다"></td>
				</tr>
			</table>
			<hr>
			<div id="pager"></div>
