...
<%
	try {
		...
		ResultSet resultSet = statement.executeQuery("select * from 학과현황 order by 연번 desc ");
		XSSFWorkbook workbook = new XSSFWorkbook();
		XSSFSheet spreadsheet = workbook.createSheet("학과현황");
		...
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/")+"학과현황.xlsx"));
	...
	String filename = "학과현황.xlsx";

	String orgfilename = "학과현황.xlsx";
