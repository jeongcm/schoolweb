...
<%
	try {
		...
		ResultSet resultSet = statement.executeQuery("select * from 학과현황양식 ");
		XSSFWorkbook workbook = new XSSFWorkbook();
		XSSFSheet spreadsheet = workbook.createSheet("학과현황 양식");
		...
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/") + "학과현황양식.xlsx"));
		workbook.write(fo);
		fo.close();
		workbook.close();
	} catch (Exception e) {
	...
	String filename = "학과현황양식.xlsx";

	String orgfilename = "학과현황양식.xlsx";
