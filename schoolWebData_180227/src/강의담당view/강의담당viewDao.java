...
public class 강의담당viewDao {
	...
	public int getCountRow() {
		String sql = "select count(*) from 강의담당view";
		try {
	...
	public List<강의담당view> select강의담당view(int page, int perPageRow) {
		int beginRow = perPageRow * page - perPageRow;
		List<강의담당view> list = new ArrayList<강의담당view>();

		String sql = "select * from 강의담당view limit ?,? ;";
		try {
			...
			while (rs.next()) {
				...
				강의담당.set단과대학(rs.getString("단과대학"));
