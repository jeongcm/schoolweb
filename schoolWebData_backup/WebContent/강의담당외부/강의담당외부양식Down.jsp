...
<%
	try {
		...
		ResultSet resultSet = statement.executeQuery("select * from 강의담당외부양식 ");
		XSSFWorkbook workbook = new XSSFWorkbook();
		XSSFSheet spreadsheet = workbook.createSheet("강의담당외부 양식");
		...
		cell.setCellValue("개설전공과목");
		cell = row.createCell(3);
		cell.setCellValue("개설교양필수과목");
		cell = row.createCell(4);
		cell.setCellValue("개설자유선택과목");
		...
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/") + "강의담당외부양식.xlsx"));
		workbook.write(fo);
		fo.close();
		workbook.close();
	} catch (Exception e) {
	...
	String filename = "강의담당외부양식.xlsx";
	String orgfilename = "강의담당외부양식.xlsx";
	InputStream in = null;
