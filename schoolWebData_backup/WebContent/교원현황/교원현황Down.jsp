...
<%
	try {
		...
		ResultSet resultSet = statement.executeQuery("select * from 교원현황 ");
		...
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/") + "교원현황.xlsx"));
	...
	String filename = "교원현황.xlsx";

	String orgfilename = "교원현황.xlsx";
