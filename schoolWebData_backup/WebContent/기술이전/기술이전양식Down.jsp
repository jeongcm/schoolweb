...
<%
	try {
		...
		ResultSet resultSet = statement.executeQuery("select * from 기술이전양식  ");
		XSSFWorkbook workbook = new XSSFWorkbook();
		XSSFSheet spreadsheet = workbook.createSheet("기술이전 양식");
		...
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/") + "기술이전양식.xlsx"));
...
<%
	...
	String filename = "기술이전양식.xlsx";

	String orgfilename = "기술이전양식.xlsx";
