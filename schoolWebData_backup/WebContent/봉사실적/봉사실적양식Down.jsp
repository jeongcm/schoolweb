...
<%
	try {
		...
		ResultSet resultSet = statement.executeQuery("select * from 봉사실적양식  ");
		XSSFWorkbook workbook = new XSSFWorkbook();
		XSSFSheet spreadsheet = workbook.createSheet("봉사실적양식");
		...
		while (resultSet.next()) {
			...
			cell = row.createCell(3);
			cell.setCellValue(resultSet.getInt("학번"));
			cell = row.createCell(4);
			cell.setCellValue(resultSet.getString("성명"));
			cell = row.createCell(5);
			cell.setCellValue(resultSet.getInt("이수학점"));
			cell = row.createCell(6);
		...
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/") + "봉사실적양식.xlsx"));
	...
	String filename = "봉사실적양식.xlsx";

	String orgfilename = "봉사실적양식.xlsx";
