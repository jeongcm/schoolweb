...
<%
	try {
		...
		ResultSet resultSet = statement.executeQuery("select * from 재학생현황양식2 ");
		XSSFWorkbook workbook = new XSSFWorkbook();
		XSSFSheet spreadsheet = workbook.createSheet("2학기 재학생 양식");
		...
		while (resultSet.next()) {
			...
			cell = row.createCell(2);
			cell.setCellValue(resultSet.getInt("학생수"));

			i++;
		}
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/") + "2학기재학생현황양식.xlsx"));
	...
	String filename = "2학기재학생현황양식.xlsx";

	String orgfilename = "2학기재학생현황양식.xlsx";
