...
<%
	try {
		...
		ResultSet resultSet = statement.executeQuery("select * from 취업률외부view;");

		XSSFWorkbook workbook = new XSSFWorkbook();
		XSSFSheet spreadsheet = workbook.createSheet("취업률_외부");
		...
		FileOutputStream fo = new FileOutputStream(
				new File(application.getRealPath("/tmpDownload/") + "외부취업률.xlsx"));
...
<%
	...
	// 서버에 실제 저장된 파일명
	String filename = "외부취업률.xlsx";

	// 실제 내보낼 파일명
	String orgfilename = "외부취업률.xlsx";
