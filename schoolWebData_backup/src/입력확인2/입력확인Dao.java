...
public class 입력확인Dao {
	...
	public int getCountRow() {
		String sql = "select count(*) from 입력확인 where 부서='중국어과' or 부서  like '%학과' or 부서 like '%전공' or 부서 like '%학부' ";
		try {
	...
	public List<입력확인> select입력확인(int page, int perPageRow) {
		...
		String sql = "select * from 입력확인 where 부서 like '%학과' or 부서 like '%전공' or 부서 like '%학부' or 부서='중국어과' order by 부서 desc limit ?,? ;";
		try {
